    ...
    >
      <div className="flex-col-auto">
        <span className="dropdown__link__title wrap">
          ...
          <span className={cn('text', { underline: failed })}>{notification.message}</span>
        </span>
        <span className="dropdown__link__account">
          <FormattedMessage id={ACCOUNT_TYPES.ids[notification.accountTypeId].name} /> &middot;
        </span>
        &nbsp;
        <span className="dropdown__link__user wrap">{notification.accountName}</span>
        &nbsp;
